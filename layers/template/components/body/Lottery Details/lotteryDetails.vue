      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="lottery-wrapper">
            ...
            <p>
              Choose your 7 luckiest numbers by clicking ( 5 numbers + 2 Lucky
              Stars).
            </p>
            <div class="row mt-50 mb-none-30">
              <div class="col-lg-4 mb-30">
                <div class="lottery-single">
                  <button class="lottery-single__close">
            ...
            <div class="lottery-wrapper__btn">
              <a href="lottery-details.html#0" class="btn-border text-white"
                >Add Tickets</a
              >
            </div>
          </div>
        ...
        <div class="col-lg-12 mt-50">
          <div class="buy-lottery-ticket">
            ...
            <div class="right">
              <a href="lottery-details.html#0" class="cmn-btn">buy tickets</a>
            </div>
          </div>
        </div>
        <!-- col-lg-12 -->
        <div class="col-lg-12 pt-120">
          <div class="pick-lottery-package">
            ...
            <div class="lottery-package-list">
              <a href="lottery-details.html#0">3 Quick Picks For $14.97</a>
              <a href="lottery-details.html#0">5 Quick Picks For $24.95</a>
              <a href="lottery-details.html#0">10 Quick Picks For $49.90</a>
              <a href="lottery-details.html#0">20 Quick Picks For $99.80</a>
            </div>
          </div>
        </div>
        <!-- col-lg-12 -->
